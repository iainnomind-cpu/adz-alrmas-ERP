...
export function CustomerList({ systemType }: CustomerListProps) {
  ...
  const [filters, setFilters] = useState<CustomerFilters & Record<string, any>>({
    searchTerm: '',
    cctvCuenta: 'all',
    cctvPlan: 'all',
    cctvDispositivo: 'all',
    ...
    alarmaPlan: 'all',
    alarmaMarca: 'all',
    alarmaTecnologia: 'all',
    gpsVehicularCuenta: 'all',
    gpsVehicularPlan: 'all',
    redCuenta: 'all',
    redPlan: 'all',
    redDispositivo: 'all',
    vpCuenta: 'all',
    ...
    vpMarca: 'all',
    vpDispositivo: 'all',
    gpsPersonalCuenta: 'all',
    gpsPersonalPlan: 'all',
    domoticaCuenta: 'all',
    domoticaPlan: 'all',
    domoticaDispositivo: 'all',
    asistenciaCuenta: 'all',
    asistenciaTipo: 'all',
    accesoCuenta: 'all',
    accesoTipo: 'all',
    status: 'all',
