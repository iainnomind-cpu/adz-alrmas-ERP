...
export const SYSTEM_ACCOUNT_CONFIG: Record<string, SystemPrefixConfig> = {
  ...
  gps_personal: { prefix: 'GPSP-', label: 'GPS Personal', isNumericOnly: false, baseOffset: 60000, moduleNumber: 6 },
  'gps personal': { prefix: 'GPSP-', label: 'GPS Personal', isNumericOnly: false, baseOffset: 60000, moduleNumber: 6 },
  gps_p: { prefix: 'GPSP-', label: 'GPS Personal', isNumericOnly: false, baseOffset: 60000, moduleNumber: 6 },
...
export const MODULES_2_TO_9 = [
  ...
  { key: 'gps_personal', label: 'GPS Personal', prefix: 'GPSP-', moduleNum: 6 },
